        ...
        <div class="col-lg-8 table-responsive mb-5">
            <table class="table table-light table-borderless table-hover text-center mb-0">
                ...
                <tbody class="align-middle">
                    ...
                    <tr>
                        <td class="align-middle"><img src="img/product-1.jpg" alt="" style="width: 50px;">{{ $cart->pizza_name}}</td>
                        <td class="align-middle">{{ $cart->pizza_price}} kyats</td>
                        <td class="align-middle">
                            <div class="input-group quantity mx-auto" style="width: 100px;">
                                ...
                                <input type="text" class="form-control form-control-sm  border-0 text-center" value="{{ $cart->quantity}}">
                                <div class="input-group-btn">
                        ...
                        <td class="align-middle">{{ $cart->pizza_price * $cart->quantity}} kyats</td>
